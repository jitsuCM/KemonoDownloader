...
class StatsWindow(QDialog):
    ...
    def __init__(self, parent, base_folder):
        ...
        # Get screen geometry and set window to 90% of screen height
        from PyQt6.QtWidgets import QApplication
        screen = QApplication.primaryScreen().geometry()
        window_height = int(screen.height() * 0.9)
        window_width = 1400
        x = 150
        y = int((screen.height() - window_height) / 2)  # Center vertically
    ...
    def plot_file_count_history(self):
        ...
        ax.set_title('Total Files Downloaded Over Time', color='white', fontsize=14, pad=5, fontweight='bold')
    ...
    def plot_total_size_history(self):
        ...
        ax.set_title('Total Downloaded Size Over Time', color='white', fontsize=14, pad=5, fontweight='bold')
        ax.set_xlabel('Date', color='white', fontsize=11)
    ...
    def plot_media_type_pie(self):
        ...
        ax.set_title('Media Type Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
        fig.patch.set_facecolor('#1A2A44')
        fig.tight_layout(pad=2.0, rect=[0, 0, 1, 0.96])
    ...
    def plot_file_size_distribution(self):
        ...
        ax.set_title('File Size Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_image_resolution_heatmap(self):
        ...
        ax.set_title('Image Resolution Heatmap', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_image_resolution_scatter(self):
        ...
        ax.set_title('Image Resolution Scatter (colored by file size)', color='white',
                    fontsize=13, pad=5, fontweight='bold')
        ax.set_xlabel('Width (px)', color='white', fontsize=11)
        ax.set_ylabel('Height (px)', color='white', fontsize=11)
        ax.grid(True, alpha=0.2, color='white', linestyle='--')
        ax.tick_params(colors='white', labelsize=9)
    ...
    def plot_image_format_distribution(self):
        ...
        ax.set_title('Image Format Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_image_color_mode(self):
        ...
        for autotext in autotexts:
            ...
            autotext.set_weight('bold')
        ax.set_title('Color Mode Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
        fig.patch.set_facecolor('#1A2A44')
        fig.tight_layout(pad=2.0, rect=[0, 0, 1, 0.96])
    ...
    def plot_image_size_histogram(self):
        ...
        ax.set_title('Image File Size Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
        ax.set_xlabel('File Size (MB)', color='white', fontsize=11)
        ax.set_ylabel('Count', color='white', fontsize=11)
        ax.grid(True, alpha=0.2, color='white', linestyle='--', axis='y')
        ax.tick_params(colors='white', labelsize=9)
    ...
    def plot_animation_duration(self):
        ...
        ax.set_title('Animation Duration Distribution', color='white', fontsize=8, pad=5, fontweight='bold')
    ...
    def plot_animation_fps(self):
        ...
        ax.set_title('Animation Frame Rate Distribution', color='white', fontsize=8, pad=5, fontweight='bold')
    ...
    def plot_animation_frame_count(self):
        ...
        ax.set_title('Animation Frame Count Distribution', color='white', fontsize=8, pad=5, fontweight='bold')
    ...
    def plot_animation_format_distribution(self):
        ...
        for autotext in autotexts:
            ...
            autotext.set_fontsize(10)
            autotext.set_weight('bold')
        ax.set_title('Animation Format Distribution', color='white', fontsize=8, pad=5, fontweight='bold')
        fig.patch.set_facecolor('#1A2A44')
        fig.tight_layout(pad=1.0, rect=[0, 0, 1, 0.99])
    ...
    def plot_animation_size_by_format(self):
        ...
        ax.set_title('Average File Size by Format', color='white', fontsize=8, pad=5, fontweight='bold')
    ...
    def plot_video_resolution_heatmap(self):
        ...
        ax.set_title('Video Resolution Heatmap', color='white', fontsize=13, pad=5, fontweight='bold')
        ax.set_xlabel('Width (px)', color='white', fontsize=11)
        ax.set_ylabel('Height (px)', color='white', fontsize=11)
        ax.tick_params(colors='white', labelsize=9)
    ...
    def plot_video_codec_distribution(self):
        ...
        ax.set_title('Video Codec Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_video_container_distribution(self):
        ...
        for autotext in autotexts:
            ...
            autotext.set_fontsize(9)
            autotext.set_weight('bold')
        ax.set_title('Container Format Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
        fig.patch.set_facecolor('#1A2A44')
        fig.tight_layout(pad=2.0, rect=[0, 0, 1, 0.96])
    ...
    def plot_video_bitrate_histogram(self):
        ...
        ax.set_title('Video Bitrate Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_audio_bitrate_histogram(self):
        ...
        ax.set_title('Audio Bitrate Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_video_duration_histogram(self):
        ...
        ax.set_title('Video Duration Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_video_fps_histogram(self):
        ...
        ax.set_title('Video Frame Rate Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_audio_channels(self):
        ...
        ax.set_title('Audio Channels Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_audio_sample_rate(self):
        ...
        ax.set_title('Audio Sample Rate Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
        ax.set_xlabel('Count', color='white', fontsize=11)
    ...
    def plot_top_creators_by_count(self):
        ...
        ax.set_title('Top 15 Creators by File Count', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_top_creators_by_size(self):
        ...
        ax.set_title('Top 15 Creators by Total Size', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_files_per_creator_distribution(self):
        ...
        ax.set_title('Files per Creator Distribution', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_size_vs_pixels(self):
        ...
        ax.set_title('File Size vs Resolution (Images)', color='white', fontsize=13, pad=5, fontweight='bold')
    ...
    def plot_size_vs_resolution_heatmap(self):
        ...
        ax.set_title('Size vs Resolution Heatmap', color='white', fontsize=13, pad=5, fontweight='bold')
        ax.set_xlabel('Resolution (Megapixels)', color='white', fontsize=11)
        ax.set_ylabel('File Size (MB)', color='white', fontsize=11)
        ax.tick_params(colors='white', labelsize=9)
    ...
    def plot_bitrate_vs_duration(self):
        ...
        ax.set_title('Video Bitrate vs Duration', color='white', fontsize=13, pad=5, fontweight='bold')
        ax.set_xlabel('Duration (seconds)', color='white', fontsize=11)
    ...
    def plot_bitrate_vs_size(self):
        ...
        ax.set_title('Video Bitrate vs File Size', color='white', fontsize=13, pad=5, fontweight='bold')
        ax.set_xlabel('File Size (MB)', color='white', fontsize=11)
        ax.set_ylabel('Bitrate (Mbps)', color='white', fontsize=11)
        ax.grid(True, alpha=0.2, color='white', linestyle='--')
        ax.tick_params(colors='white', labelsize=9)
    ...
    def plot_timeline_stacked(self):
        ...
        ax.set_title('Download Timeline by Media Type', color='white', fontsize=13, pad=5, fontweight='bold')
        ax.set_xlabel('Date', color='white', fontsize=11)
    ...
    def plot_aspect_ratio_distribution(self):
        ...
        ax.set_title('Top 15 Aspect Ratios', color='white', fontsize=13, pad=5, fontweight='bold')
        ax.set_xlabel('Count', color='white', fontsize=11)
